...
if (command === "terminology") {
  ...
  console.log(
    'bun database.ts personas add --name "日本語名前" --base_style "สไตล์การพูด" --negative_constraints "ข้อจำกัด" --example "ตัวอย่างประโยค" --alias "ชื่อภาษาไทย"',
  );
  console.log(
    'bun database.ts personas update --name "日本語名前" --base_style "สไตล์ใหม่" --negative_constraints "ข้อจำกัดใหม่" --example "ตัวอย่างเพิ่มเติม" --alias "EnglishAlias"',
  );
